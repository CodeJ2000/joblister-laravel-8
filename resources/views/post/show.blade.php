...
@section('content')
<section class=" post-background show-page pt-4 mb-5">
  <div class="container">
    <div class="row">
      <div style="background: #ffff" class="col-sm-12 col-md-8 rounded pt-3 pb-3 mb-2">
        <div class="job-listing border">
          <div class="company-info">
            ...
            {{-- company information --}}
            <div style="background: #ffff" class="p-3">
