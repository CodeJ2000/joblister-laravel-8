        ...
        <div class="col-sm-12 col-md-6 px-0">
            <div class="login-container">
                <div class="login-header mb-3">
                    <h3> <img src="{{asset('images/logo/getwork.png')}}" width="50px;" alt="">Job Finder <span style="color: orangered;">|</span> Tandag City Login</h3>
                    <p class="login-header-title">Welcome back to Job Finder</p>
...
<style>
.login-poster {
   background-image: url('{{asset("images/banner/boulevard.jpg")}}');
    background-image: linear-gradient(
            to bottom,
            rgba(0, 0, 0, 0.5),
            rgba(0, 0, 0, 0.35)
        ),
        url('{{asset("images/banner/boulevard.jpg")}}');
