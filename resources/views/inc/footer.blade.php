  ...
  <div class="footer-main">
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-6 col-md-3">
          <div class="footer-links">
            <h3 class="footer-brand mb-2">Job Finder</h3>
            <div class="footer-link-list">
             <a href="#" class="footer-links"><i class="fas fa-compass"></i> Tandag City, Surigao Del Sur</a>
            
             <a href="mailto:jobfinder@tandag.com" class="footer-links"><i class="fas fa-envelope"></i> jobfinder@tandag.com</a>
            </div>
          </div>
        </div>
      </div>
