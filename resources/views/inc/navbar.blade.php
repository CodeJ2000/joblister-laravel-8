<nav style="background: #f5f6fa" class="navbar navbar-expand-md navbar-white border-bottom sticky-top" id="navbar">
  <div class="container">
  <a href="{{URL('/')}}" class="navbar-brand">
    <img src="{{asset('images/logo/getwork.png')}}" width="50px;" alt=""> Job Finder <span style="color: orangered;">|</span> Tandag City
    </a>
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown dropdown-left"> 
          ...
          <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown"> 
            @role('admin')
            <a class="dropdown-item" href="{{route('account.dashboard')}}"> <i class="fas fa-cogs fa-sm "></i>Admin Dashboard</a> 
            @endrole
            @role('author')
            <a class="dropdown-item" href="{{route('account.authorSection')}}"> <i class="fa fa-cogs fa-sm "></i> Employer Dashboard </a> 
            @endrole
